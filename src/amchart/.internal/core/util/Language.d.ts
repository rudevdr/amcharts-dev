 ...
 */
export declare class Language extends Entity {
    _settings: ILanguageSettings;
    _privateSettings: ILanguagePrivate;
     ...
     * @return           Translation
     */
    translate<Key extends keyof ILocaleSettings>(prompt: Key, locale?: ILocale, ...rest: Array<string>): string;
    /**
     ...
     * @param  locale        Target locale
     */
    setTranslationsAny(translations: {
        [index: string]: any;
    }, locale?: ILocale): void;
    translateEmpty<Key extends keyof ILocaleSettings>(prompt: Key, locale?: ILocale, ...rest: Array<string>): string;
     ...
     */
    translateAll<Key extends keyof ILocaleSettings>(list: Array<Key>, locale?: ILocale): Array<string>;
    /**
