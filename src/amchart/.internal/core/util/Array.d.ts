...
export declare function removeFirst<A>(array: Array<A>, element: A): boolean;
/**
 ...
 * @param element  Item to add
 */
export declare function pushOne<A>(array: Array<A>, element: A): void;
/**
 ...
 * @returns Index of the item if found
 */
export declare function findIndexReverse<A>(array: ArrayLike<A>, matches: (value: A, index: number) => boolean): number;
/**
 ...
 * @returns Item if found
 */
export declare function findReverse<A>(array: ArrayLike<A>, matches: (value: A, index: number) => boolean): A | undefined;
/**
 * Searches the array using custom function and returns item if found.
 *
 ...
 * @returns Item if found
 */
export declare function findMap<A, B>(array: ArrayLike<A>, matches: (value: A, index: number) => B | undefined): B | undefined;
/**
 * Iterates through all items in array and calls `fn` function for each of
 * them.
 *
 ...
 */
export declare function getSortedIndex<A>(array: ArrayLike<A>, ordering: (left: A) => Ordering): SortResult;
/**
 ...
 * @returns Result of the search
 */
export declare function getFirstSortedIndex<A>(array: ArrayLike<A>, ordering: (left: A) => Ordering): SortResult;
